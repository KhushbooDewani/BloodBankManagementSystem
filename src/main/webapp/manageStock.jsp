...
{
%>
<center><font color="black" size="6">Something went wrong! Try Again!</font>
<%} %> 
<%
if("valid".equals(msg))
{
%>
<center><font color="black" size="6">Successfully Updated</font></center>
<%} %> 
...
<th style="background-color:#ff6347">Units</th>
</tr>
<tr>
<%
try
